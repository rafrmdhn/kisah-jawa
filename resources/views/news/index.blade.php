        ...
        <div class="container">
            <div class="owl-carousel owl-carousel-2 carousel-item-3 position-relative">
                @foreach($topNews as $news)
                    <div class="d-flex">
                        <img src="{{ asset($news->gambar) }}" style="width: 80px; height: 80px; object-fit: cover;">
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                        ...
                        <div class="position-relative overflow-hidden" style="height: 435px;">
                            <img class="img-fluid h-100" src="{{ asset($news->gambar) }}" style="object-fit: cover;">
                            <div class="overlay">
                                <div class="mb-1">
                ...
                <div class="col-lg-4">
                    ...
                    @foreach ($categoryCards as $card)
                        <div class="position-relative overflow-hidden mb-3" style="height: 80px;">
                            <img class="img-fluid w-100 h-100" src="{{ asset($card['img']) }}" style="object-fit: cover;">
            ...
            <div class="owl-carousel owl-carousel-2 carousel-item-4 position-relative">
                @foreach($featuredNews as $news)
                    <div class="position-relative overflow-hidden" style="height: 300px;">
                        <img class="img-fluid w-100 h-100" src="{{ asset($news->gambar) }}" style="object-fit: cover;">
                        <div class="overlay">
                        ...
                        <div class="owl-carousel owl-carousel-3 carousel-item-2 position-relative">
                            @foreach($category->articles as $artikel)
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="{{ asset($artikel->gambar) }}" style="object-fit: cover;">
                            ...
                            @foreach($popularLeft as $key => $artikel)
                                ...
                                @else
                                    ...
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset($artikel->gambar) }}" style="width: 100px; height: 100px; object-fit: cover;">
